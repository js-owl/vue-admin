  ...
  computed: {
    ...
    commentsById() {
      return this.comments.filter(
        (item) => item.comment_target === 'generalToolTitle'
      )
    }
  },
  methods: {
    addComment() {
      ...
      this.commentData = {
        ...
        comment_target: 'generalToolTitle'
      }
    ...
    editTool(row) {
      this.activeRow = row
      Object.assign(this.toolData, row)
      this.isToolOpen = true
    },
    saveTool() {
      Object.assign(this.activeRow, this.toolData)
    }
  }
}
</script>
